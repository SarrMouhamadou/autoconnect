...
export default function ProfilPage() {
    const { user, isConcessionnaire } = useAuth();
        ...
        <DashboardLayout title="Mon profil">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        <div className="px-6 py-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                            ...
                            <Link
                                to="/concessionnaire/profil/edit"
                    ...
                    {/* Informations entreprise (concessionnaire) */}
                    {isConcessionnaire() && (
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="space-y-6">
                    {/* Barre de progression (si concessionnaire incomplet) */}
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div className="px-6 py-6 text-center">
                            <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-teal-100 flex items-center justify-center overflow-hidden">
                                {user?.photo_profil ? (
                                    <img
                            ...
                            <Link
                                to="/concessionnaire/profil/edit"
                                className="inline-block px-4 py-2 text-sm font-medium text-teal-600 hover:text-teal-700"
                            >
                                Changer la photo
                            </Link>
                        </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div className="px-6 py-4 space-y-2">
                            ...
                            <Link
                                to="/concessionnaire/profil/change-password"
                                className="flex items-center p-3 rounded-lg hover:bg-gray-50 transition"
                            >
                                <svg className="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
